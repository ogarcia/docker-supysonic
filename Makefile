ALPINE_VERSION := 3.15
PYTHON_VERSION := 3.10
SUPYSONIC_VERSION := 62bad3b9878a1d22cf040f25dab0fa28a252ba38
...
docker-build:
	docker buildx build -t $(DOCKER_ORGANIZATION)/$(DOCKER_IMAGE) --build-arg ALPINE_VERSION=$(ALPINE_VERSION) --build-arg PYTHON_VERSION=$(PYTHON_VERSION)-alpine$(ALPINE_VERSION) --build-arg SUPYSONIC_VERSION=$(SUPYSONIC_VERSION) .
