ALPINE_VERSION := 3.13
PYTHON_VERSION := 3.9
SUPYSONIC_VERSION := 8eca8ba60f134b677e5943674508cd2c34f46f7a
...
docker-build:
	docker build -t $(DOCKER_ORGANIZATION)/$(DOCKER_IMAGE) --build-arg ALPINE_VERSION=$(ALPINE_VERSION) --build-arg PYTHON_VERSION=$(PYTHON_VERSION)-alpine$(ALPINE_VERSION) --build-arg SUPYSONIC_VERSION=$(SUPYSONIC_VERSION) .
